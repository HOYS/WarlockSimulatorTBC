...
extern "C"
{
    ...
    CharacterStats* allocStats(int health, int mana, double stamina, double intellect, double spirit, double spellPower, int naturePower, int firePower, int hasteRating, int hitRating, int critRating
