...
{
    int suppression;
    int improvedCorruption;
    int improvedLifeTap;
    int improvedCurseOfAgony;
    int amplifyCurse;
    int nightfall;
    int empoweredCorruption;
    int siphonLife;
    int shadowMastery;
    int contagion;
    int darkPact;
    int unstableAffliction;
    ...
    Talents(int suppression, int improvedCorruption, int improvedLifeTap, int improvedCurseOfAgony, int amplifyCurse, int nightfall, int empoweredCorruption, int siphonLife, int shadowMastery, int contagion
