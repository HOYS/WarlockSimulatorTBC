...
Auras::Auras(bool felArmor, bool blessingOfKings, bool blessingOfWisdom, bool judgementOfWisdom, bool manaSpringTotem, bool wrathOfAirTotem, bool totemOfWrath, bool markOfTheWild, bool arcaneIntellect
    ...
    , eyeOfTheNight(eyeOfTheNight), chainOfTheTwilightOwl(chainOfTheTwilightOwl), jadePendantOfBlasting(jadePendantOfBlasting), idolOfTheRavenGoddess(idolOfTheRavenGoddess), drumsOfBattle(drumsOfBattle)
    ...
    , petPrayerOfSpirit(petPrayerOfSpirit), petKiblersBits(petKiblersBits), petHeroicPresence(petHeroicPresence), petStrengthOfEarthTotem(petStrengthOfEarthTotem), petGraceOfAirTotem(petGraceOfAirTotem)
