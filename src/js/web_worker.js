...
onmessage = function (e) {
  ...
  .then(module => {
    ...
    , parseInt(c['target-fire-resistance']), parseInt(c.mageAtieshAmount), parseInt(c.totemOfWrathAmount)
    ...
    , parseInt(c.bloodlustAmount), parseInt(c.innervateAmount), parseInt(c.enemyArmor), parseInt(c.exposeWeaknessUptime), c.improvedFaerieFire === "yes", c.infinitePlayerMana === "yes"
    , c.lashOfPainUsage === "onCooldown", c.randomizeValues === "yes", c.rotationOption === "simChooses", c.shattrathFactionReputation === "yes"
    , parseInt(c.survivalHunterAgility), d.dot.flameshock, d.dot.corruption, d.dot.siphonLife, d.filler.lightningBolt, d.curse.curseOfRecklessness
    , d.curse.curseOfTheElements, d.curse.curseOfAgony
